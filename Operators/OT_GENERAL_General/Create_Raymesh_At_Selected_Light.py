...
class Radiant_OT_Create_Raymesh_At_Selected_Lights(bpy.types.Operator):
    """Create RayMesh At Selected Lights"""
    bl_idname = "radiant.create_raymesh_at_selected_lights"
    bl_label = "Create Raymesh At Selected Lights"
...
classes = [Radiant_OT_Create_Raymesh_At_Selected_Lights]
